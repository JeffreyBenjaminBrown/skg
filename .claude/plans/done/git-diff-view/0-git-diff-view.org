...
** BufferRoot
   ...
   In Skg, a buffer's tree structure has BufferRoot at the top;
   level-1 headlines are its children. BufferRoot is never rendered.
...
** Special case: root nodes
   ...
   or is a direct child of BufferRoot (i.e., a level-1 headline),
