* why Skg
We must improve human nature before we destroy ourselves. Every adult has an obligation to continue studying the things we tell children we understand: love, justice, art, death, honor, peace, desire, all the high ideas. But the universe of things to study is big. We can't do it well without helping each other.
...
Skg is free software, without even a known path toward monetization.
* what Skg is
Skg is software for manipulating and sharing knowledge. (Yes, we already do those things, but poorly; please keep reading.) Skg extends the concept of personal knowledge management (familiar from software like logseq, org-roam, Notion, Roam, Obsidian, Tana, and others) to an experience that can be shared.
...
* Want to help?
  If so please say so. I would work hard to bring you onboard. Even questions about the documentation would be greatly appreciated.
