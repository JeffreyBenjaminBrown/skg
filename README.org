* pitching skg
We must change human nature. We cannot change what we do not know. We We have an obligation to study and describe to each other our minds and the world, to keep learning as adults the things we tell children we understand: humility, courage, spacetime, desire, all the high ideas.

We must therefore share the creation of a web of knowledge. As a side benefit, the app will permit private webs of knowledge, integrated seamlessly with the public ones.
** Is it absurd?
These hopes are predicated on people wanting to write about the high ideas, and believing they can gain from sharing the experience.

It will be like social media, but less performative. You don't supply a stream, but a collection of accrreting information. It is less doing, more being.

It will be like academia, but it rewards (if you count views) generality, not specificity.
** quantum (like Schrodinger's cat) information
If you fear belonging to a minority ignored by the dictator of truth, don't fear. There is room for all knowledge, multiply categorized. Different writers can testify to different things. Nobody dictates "the" article on anything; there are only views onto the collective information. You curate what you see, can promote and render invisible (to yourself and anyone who wants your lens) whole people or person-topic pairs however you wish. The result will be navigable, due to two innovations: (1) graphs, and (2) letting the user, not an alien invisible algorithm, choose what to see.
** Welcome to the matrix, err, forest-web
Knowledge is a forest-web. This is not strange or technical: Everyone naturally writes (at least sometimes) tree-shaped documents. Divide some text into sections, some sections into subsections, etc. Dividing it makes a tree. Multiple such documents are called a forest. The forest becomes a forest-web when it includes [[ordinary internet-style text hpyerlinks]]. Each point in the forest-web contains some text, which can contain any number (especially zero) of hyperlinks.
** Integrate your forest-web with others'.
Hopefully some people will share some of their trees, and you will find some trees by other people interesting. If so, Skg will let you do what *feels like* editing their data -- reordering branches, hiding branches, plugging branches from their tree into branches of your own trees. You're not actually changing their data; you're creating a lens onto it. When the original author edits those branches, you'll receive their changes.
...
* how skg works
** It's not very strange, I promise.
...
** graph, view and the 'contains' relationship
   A user's knowledge is represented as a graph ("forest-web"). Each node ("point") in the graph has a "title" (just text), a "body" (just text), a unique ID (a long number) and a 'data source'. Sources are for sharing and privacy, described later.
