* understand it
** TODO What's the logic behind this comment?
...
**** TODO mark_repeats_and_extend_defmap
...
**** TODO flatten the call to mark_repeats_and_extend_defmap
***** detect_and_mark_cycle
      implemented
***** the rest
      Get the node's PID.
      If that PID is in the defMap, mark this one indefinitive.
        No need to recurse.
      If this one is (still, because the last line ran)
        definitive, insert it into defMap.
**** complete_or_restore_each_node_in_branch
