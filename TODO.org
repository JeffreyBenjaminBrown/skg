* TODO RESUME READING at
  rust/mk_org_text/content_view.rs
* reorganize
** shuffle file_io::*
   In ::update_fs
     update_fs_from_saveinstructions goes to save::
     The others go to file_io::more.
   Move ::more::load_config to a new ::misc.
   Rename ::more to ::multiple_nodes.
** rename
...
* QA
** refactor completeContents and neighbors
*** check_and_mark_repetition
    it seems to mix concerns
*** completeContents
    it's just too long
