...
*** Can from_parsed be simplified?
    Looks like a dangerous lot of boilerplate.
*** delete folded and focused from OrgnodeViewData
*** functions to delete in server/types/orgnode.rs
**** impl OrgNode {
***** should_be_sourceless
***** id
***** title
***** is_true_node
***** is_scaffold_any
...
***** set_num_contents
***** set_num_links_in
***** set_parent_is_container
***** set_parent_is_content ( &mut self, value : bool ) {
***** set_effect_on_parent ( &mut self, effect : EffectOnParent ) {
...
** change metadata rendering
   'code' is now an obsolete s-exp title, etc.
** type changes
