...
* rename save types
** Merge should be three Saves
** SaveInstruction -> ChangeOneNode
** MergeInstructionTriple -> Merge
** aborted
...
* ONGOING write thoughts/buffer-update.org
* Should 'SaveInstruction' have smelled bad?
