...
**** the ensure_skgnode call is a wart
     but it would require changing a lot of functions
     to earlier build a map from ID to skgnode for the whole tree,
     and not keep skgnode in the tree at all
