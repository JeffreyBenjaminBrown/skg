* rename OrgNode -> ViewNode
* TODO use just one kind of diff
  thoughts/git-diff-report.org
** ONGOING remove Diff_as_TwoLists_Lossy
* ONGOING thoughts/buffer-update.org
* internalizing
