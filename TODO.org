...
*** write helpers to simplify egotree boilerplate
**** 'do to ancestor'
     Takes a treenode id, an int 'generation' (0 is valid), and a lambda.
     Does the lambda to the ancestor.
     0 represents the input node.
     read_at_node_in_tree and write_at_node_in_tree should call this,
       supplying generation 0.
...
** read_skg_files_from_folder is stupid
