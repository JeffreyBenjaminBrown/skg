* if the node immediately branches, these should show all branches
** skg-branch-containerward
** skg-branch-sourceward
* ONGOING rename user commands
Let's hide the name skg-request-title-matches from the user,
and instead give them the alias skg-search-titles.
...
* rename path_to_end_cycle_and_or_branches
