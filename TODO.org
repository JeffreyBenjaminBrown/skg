* flatten mark_if_visited_or_repeat_or_cycle
* understand it
** [[id:9e83b23b-ebcb-426a-a1aa-6ceeabaaef2f][Skg save data flow trace]]
** Why is show not reusable in save?
* extend it
** save subscribees
...
** show subscribees
* refactor it
** ONGOING There seem to be unnecessary mid-functions.
   as in midparent in a tree
*** instances
**** TODO flatten add_missing_info_to_forest
...
** ? could initial buffer creation be rewritten in terms of save
*** root or roots each with a definitive view request
*** but maybe definitive view requests are in terms of de novo creation
