...
* herald : links to this node with content
** Those links should be drawn with their containerweard paths.
** That is the same as
   'places this node has been used as a connector'.
** [[id:59e54472-f770-437d-bc36-323928dd3352][linked to in container]] herald :? hard problem
* herald : source
* private view
