...
#
# A plain-text org-mode summary is written to tests/results/ALL.org,
# and individual results to tests/results/ as separate files.
#
# When integration tests fail, re-runs the failures in isolation
