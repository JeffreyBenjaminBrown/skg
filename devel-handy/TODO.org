* HeadlineInfo should have a parsed Metadata, not a metadata string
* refactor: retain tree
  serial, control flow
** interpret_org_node2
*** TODO refuse and report all problems if any of these happen
**** TODO a node appears twice without 'rep' or 'mightContainMore'.
