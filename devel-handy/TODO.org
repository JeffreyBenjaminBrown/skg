...
* search for TODO items
  in .rs and .el (and .md?) files
* Deal with duplicated titles in search.
  I think it might be because the DB is persisted.
  Also, TypeDB and Tantivy should read from the same folder, but currently don't -- see serve.rs.
