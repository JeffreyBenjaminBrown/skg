* merge [[id:7b2499c4-4c93-44dc-83b1-0a4b9175d6a8][containerward view]] into main
* integration tests
** updating `cargo run --bin skg` script
   Keep it running in the background.
   Restart it when source code changes.
...
** (more?) places with potential redundancy
*** rust rendering
    rust/render/*.rs (except util.rs)
*** in rust/serve
    rust/serve/containerward_view.rs
    and the others
