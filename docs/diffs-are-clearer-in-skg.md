...
For the data structure that makes this possible, see the
[technical data model](data-model_technical.org) and the
[Skg extensions](data-model-skg-extensions.md).
