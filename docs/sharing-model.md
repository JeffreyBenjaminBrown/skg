...
- **Foreign override edges never substitute.** If someone else's node overrides one of yours, that is a display-only fact (it can earn an herald), but it does not change what you see. Only your own overrides substitute (those from sources under your `owned` folder; see `docs/accordions.md`, "Ownership and folders").
