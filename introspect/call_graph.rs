...
/// For implementations, the name used is 'TypeName::method_name'. The line count includes everything, even the header comment, except blank lines. The program only analyzes rust/. It ignores macros.
