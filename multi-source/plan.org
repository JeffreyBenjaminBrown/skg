...
- [ ] Nodes inherit source from parent during save (Phase 6)
...
Recommendation: Wait for Phase 6/8 when foreign data handling requires it.
...
Recommendation: Wait for Phase 6. Current single-source =run_with_test_db= sufficient.
