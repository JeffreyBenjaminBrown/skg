...
local function buffer_metadata (descriptor, undo, windows)
  ...
  return {
    ...
    field('origin-buffer-id', record.origin_buffer_id or 'none'),
    field('origin-view-uri', record.origin_view_uri or 'none'),
    field('origin-application-token',
      record.origin_application_token or 'none'),
    field('origin-location', record.origin_location or 'none'),
