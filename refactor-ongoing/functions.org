...
** DONE add_children_and_collect_their_ids_v2
...
** DONE build_and_integrate_aliases_v2
...
** DONE build_and_integrate_aliases_view_then_drop_request_v2
...
** DONE build_and_integrate_containerward_path_v2
...
** DONE build_and_integrate_containerward_view_then_drop_request_v2
...
** DONE build_and_integrate_sourceward_path_v2
...
** DONE build_and_integrate_sourceward_view_then_drop_request_v2
...
** DONE clobberIndefinitiveOrgnode_v2
...
** DONE collect_rels_to_children_from_generation_v2
...
** DONE complete_or_restore_each_node_in_branch_v2
...
*** ensure_source
** DONE execute_definitive_view_request_v2
...
** DONE extendDefinitiveSubtreeFromLeaf_v2
...
** DONE integrate_branches_in_node_v2
...
** DONE integrate_cycle_in_node_v2
...
** DONE integrate_linear_portion_of_path_v2
...
** DONE integrate_path_that_might_fork_or_cycle_v2
...
** DONE maybe_add_hiddenInSubscribeeCol_branch_v2
...
** DONE maybe_add_subscribeeCol_branch_v2
...
** DONE orgnode_forest_to_string_v2
pub fn orgnode_forest_to_string_v2 (
  forest : &Tree<OrgNode>,
) -> Result < String, Box<dyn Error> >
*** orgnode_forest_to_string
** DONE prepend_indefinitive_child_with_parent_ignores_v2
...
** DONE render_generation_and_recurse_v2
...
** DONE render_initial_forest_bfs_v2
...
** DONE set_metadata_relationship_viewdata_in_forest_v2
...
*** single_root_view
** DONE stub_forest_from_root_ids_v2
...
** DONE truncate_after_node_in_generation_in_tree_v2
...
** DONE update_from_and_rerender_buffer_v2
...
** DONE append_indefinitive_from_disk_as_child_in_orgtree
...
** DONE find_child_by_id_in_orgtree
pub fn find_child_by_id_in_orgtree (
  tree          : & Tree<OrgNode>,
  parent_treeid : ego_tree::NodeId,
  target_skgid  : & ID,
) -> Option < ego_tree::NodeId >
** DONE find_children_by_ids_in_orgtree
...
** DONE insert_scaffold_as_child_in_orgtree
