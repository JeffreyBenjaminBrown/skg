...
//! regression the accordion carries relative to the retired chain
//! design -- a foreign accordion's fold ORDER lives in the
...
//! DEPENDENCIES.toml listing the sources its accordion sections may
      ...
      if let Some ((prev_repo, prev_position)) = &last {
        if position < *prev_position {
          warnings . push ( format! (
            "Source '{}' ships a DEPENDENCIES.toml placing '{}' more public than '{}', but this config orders them the other way. Accordions spanning them will fold in the publisher-unintended order; consider reordering [[sources]].",
            name, prev_repo, repo )); }}
