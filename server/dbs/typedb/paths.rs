...
// relationships.  An in-Rust-graph alternative exists: 'content_maps_from_nodes'
...
// run entirely in-Rust-graph (microseconds vs seconds for large graphs).
// As of 2026-03 the TypeDB path is used because it is simpler to
// plumb through, and performance has not been a bottleneck here.
