...
use crate::serve::util::{send_response_with_length_prefix, tag_sexp_response};
use crate::types::git::SourceDiff;
use crate::types::misc::{ID, SourceName, SkgConfig};
use crate::types::memory::{SkgNodeMap, ViewUri};
use crate::types::viewnode::ViewNode;
use crate::update_buffer::{
  rerender_view, seed_skgnodemap_from_pool, merge_skgnodemap_into_pool};
...
pub fn handle_rerender_all_views_request (
  ...
  { Ok (( views, errors )) => {
      ...
      send_response_with_length_prefix (
        stream,
        & tag_sexp_response (
          TcpToClient::RerenderAllViews, &sexp )); }
    Err (e) => {
      let sexp : String =
