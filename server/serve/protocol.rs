...
impl RequestType {
  pub fn from_client_string (
    ...
    match s {
      ...
      "query wait"               => Ok (RequestType::QueryWait),
      "query wait status"        => Ok (RequestType::QueryWaitStatus),
      "query wait cancel"        => Ok (RequestType::QueryWaitCancel),
      "query wait applied"       => Ok (RequestType::QueryWaitApplied),
...
impl TcpToClient {
  pub fn repr_in_client (
    ...
    match self {
      ...
      TcpToClient::RefreshQueued => "refresh-queued",
