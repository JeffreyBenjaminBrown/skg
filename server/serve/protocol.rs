...
impl RequestType {
  pub fn from_client_string (
    ...
    match s {
      ...
      "link statuses"            => Ok (RequestType::LinkStatuses),
      "diff analysis"            => Ok (RequestType::DiffAnalysis),
      "stage moves"              => Ok (RequestType::StageMoves),
      "relSource info"          => Ok (RequestType::RelSourceInfo),
      "property state"            => Ok (RequestType::BoolPropState),
...
impl TcpToClient {
  pub fn repr_in_client (
    ...
    match self {
      ...
      TcpToClient::LinkStatuses     => "link-statuses",
      TcpToClient::DiffAnalysis     => "diff-analysis",
      TcpToClient::StageMoves       => "stage-moves",
      TcpToClient::RelSourceInfo    => "relSource-info",
      TcpToClient::BoolPropState     => "property-state",
