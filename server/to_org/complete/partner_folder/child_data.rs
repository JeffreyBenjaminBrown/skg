...
///   manage: for PartnerFolders, an ActiveNode marked parentIs=affected.
...
use crate::types::viewnode::{ViewNode, ViewNodeKind, Vognode, ParentIs, PartnerFolder, mk_indefinitive_viewnode, mk_phantom_viewnode, mk_unknown_viewnode};
