...
pub enum BufferValidationError {
  ...
  DefinitiveRequestOnNodeWithContentChildren (ID), // A definitive view request on a node that has content (parentIs=Container) children. Non-content children (e.g. content ancestry stubs) don't trigger this.
