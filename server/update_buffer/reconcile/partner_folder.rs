...
use crate::types::viewnode::{FolderPolicy, ParentIs, PartnerFolder, ViewNode, ViewNodeKind, Vognode};
...
/// about that node.
/// Makes the folder's ActiveNode children marked parentIs=affected match a goal list,
...
/// the folder's existing Active parentIs=Affected children, in their
