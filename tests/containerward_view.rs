...
async fn test_containerward_org_view (
  ...
  let expected2 = "\
    ...
    **** <skg<id:1>> 1
    ";
  assert_eq!(result2, expected2.trim_start());
  ...
  let expected3 = "\
    ...
    **** <skg<id:2,cycle>> 2
    ";
  assert_eq!(result3, expected3.trim_start());
  ...
  let expected4b = "\
    ...
    **** <skg<id:1>> 1
    ";
  assert!(result4 == expected4a.trim_start() ||
          result4 == expected4b.trim_start(),
          "Expected one of {:?} or {:?}, got {:?}",
          expected4a.trim_start(),
          expected4b.trim_start(),
          result4);
  ...
  let expected5b = "\
    ...
    *** <skg<id:1>> 1
    ";
  assert!(result5 == expected5a.trim_start() ||
          result5 == expected5b.trim_start(),
          "Expected one of {:?} or {:?}, got {:?}",
          expected5a.trim_start(),
          expected5b.trim_start(),
          result5);
  ...
  let expected6b = "\
    ...
    ** <skg<id:shared_cyclic_1>> shared_cyclic_1
    ";
  assert!(result6 == expected6a.trim_start() ||
          result6 == expected6b.trim_start(),
          "Expected one of {:?} or {:?}, got {:?}",
          expected6a.trim_start(),
          expected6b.trim_start(),
          result6);
  ...
  let expected7b = "\
    ...
    *** <skg<id:shared_cyclic_1,cycle>> shared_cyclic_1
    ";
  assert!(result7 == expected7a.trim_start() |
          | result7 == expected7b.trim_start(),
          "Expected one of {:?} or {:?}, got {:?}",
          expected7a.trim_start(),
          expected7b.trim_start(),
          result7);
