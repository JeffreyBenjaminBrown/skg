...
fn test_definitive_view_limit_10
  ...
  run_with_test_db (
    ...
    |config, driver, tantivy| Box::pin ( async move {
      ...
      let expected = indoc! {"
        * (skg (node (id 1) (source main) (graphStats (containers 0) (contents 3)))) 1
    ...
    |config, driver, tantivy| Box::pin ( async move {
      ...
      let result_5 = {
        ...
        let response_5 = update_from_and_rerender_buffer (
          ...
          SkgNodeMap::new() ). await ?;
        response_5.response.saved_view };
      let result_6 = {
        ...
        let response_6 = update_from_and_rerender_buffer (
          ...
          SkgNodeMap::new() ). await ?;
        response_6.response.saved_view };
      ...
      let expected = indoc! {"
        ...
        *** (skg (node (id 122) (source main) indefinitive (graphStats (contents 1)))) 122
    ...
    |config, driver, tantivy| Box::pin ( async move {
      ...
      let result_1 = {
        ...
        let response_1 = update_from_and_rerender_buffer (
          input_org_text, driver, &config1, tantivy, false, SkgNodeMap::new() ) . await ?;
        response_1.response.saved_view };
      let result_4 = {
        let mut config4 = config.clone();
        config4.initial_node_limit = 4;
        let response_4 = update_from_and_rerender_buffer (
          input_org_text, driver, &config4, tantivy, false, SkgNodeMap::new() ) . await ?;
        response_4.response.saved_view };
      ...
      let expected = indoc! {"
        ...
        ** (skg (node (id 12) (source main) (graphStats (contents 4)))) 12
        12 body
        *** (skg (node (id 121) (source main) indefinitive (graphStats (contents 2)))) 121
        *** (skg (node (id 122) (source main) indefinitive (graphStats (contents 1)))) 122
        *** (skg (node (id 123) (source main) indefinitive)) 123
        *** (skg (node (id 124) (source main) indefinitive)) 124
        ** (skg (node (id 13) (source main))) 13
  ...
  run_with_test_db (
    ...
    |config, driver, tantivy| Box::pin ( async move {
      ...
      let result = {
        ...
        let response = update_from_and_rerender_buffer (
          input_org_text, driver, &config, tantivy, false, SkgNodeMap::new() ) . await ?;
        response.response.saved_view };
      ...
      let expected = indoc! {
        ...
        "* (skg (node (id 1) (source main) (graphStats (containers 0) (contents 1)))) 1
...
fn test_definitive_view_with_cycle
  ...
  run_with_test_db (
    ...
    |config, driver, tantivy| Box::pin ( async move {
      ...
      let expected = indoc! {"
        * (skg (node (id cyc-a) (source main) (graphStats (contents 1)))) cyc-a
        cyc-a body
        ** (skg (node (id cyc-b) (source main) (graphStats (contents 1)) (viewStats containsParent))) cyc-b
        cyc-b body
        *** (skg (node (id cyc-a) (source main) indefinitive (graphStats (contents 1)) (viewStats cycle containsParent))) cyc-a
      "};
