...
fn test_bfs_limit_across_multiple_trees
  ...
  run_with_test_db (
    ...
    |config, driver, _tantivy| Box::pin ( async move {
      ...
      let expected = indoc! {"* (skg (node (id 1) (source main) (graphStats (containers 0) (contents 3) (containsHerald 0{3)))) 1
                              ...
                              * (skg (node (id 2) (source main) (graphStats (containers 0) (contents 3) (containsHerald 0{3)))) 2
                              ...
                              * (skg (node (id 3) (source main) indefinitive (graphStats (containers 0) (contents 3) (containsHerald 0{3)))) 3
                              "};
