...
fn test_bfs_limit_across_multiple_trees
  ...
  run_with_test_db (
    ...
    |config, driver, _tantivy| Box::pin ( async move {
      ...
      let expected = indoc! {"* (skg (node (id 1) (source main) (birth independent) (graphStats (containers 0) (contents 3) (containsHerald 0{3)))) 1
                              ** (skg (node (id 11) (source main) indefinitive)) 11
                              ** (skg (node (id 12) (source main) indefinitive (graphStats (contents 3) (containsHerald {3)))) 12
                              ** (skg (node (id 13) (source main) indefinitive)) 13
                              * (skg (node (id 2) (source main) (birth independent) (graphStats (containers 0) (contents 3) (containsHerald 0{3)))) 2
                              ** (skg (node (id 21) (source main) indefinitive)) 21
                              ** (skg (node (id 22) (source main) indefinitive (graphStats (contents 3) (containsHerald {3)))) 22
                              ** (skg (node (id 23) (source main) indefinitive)) 23
                              * (skg (node (id 3) (source main) (birth independent) indefinitive (graphStats (containers 0) (contents 3) (containsHerald 0{3)))) 3
                              "};
