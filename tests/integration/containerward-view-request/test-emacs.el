    ...
    (let* ((buffer-content (buffer-substring-no-properties
           ...
           (expected-without-metadata
            ...
            (concat "* 1\n"
                    ...
                    "** 13\n"))
           (expected
            (concat "* (skg (node (id 1) (source main) (parentIs absent) (rels (blue \"1C3\")))) 1\n"
                    "** (skg (node (id 11) (source main) (rels (yellow \"a\") (white \"C\")))) 11\n"
                    "** (skg (node (id 12) (source main) (rels (yellow \"a\") (white \"C1\")))) 12\n"
                    "*** (skg (node (id 1) (source main) (parentIs independent) indef (rels (white \"1C3\") (yellow \"a\")) (viewStats cycle))) 1\n"
                    "**** (skg (node (id 0) (source main) (parentIs independent) indef (rels (white \"C\") (yellow \"a\")))) 0\n"
