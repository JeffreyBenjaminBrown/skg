    ...
    (let* ((buffer-content (buffer-substring-no-properties
           ...
           (expected
            (concat "* (skg (node (id 1) (source main) (affectsParent na) (rels (contains (in 1) (out 3))))) 1\n"
                    ...
                    "*** (skg (node (id 1) (source main) (affectsParent false) indef (rels (contains (in 1) (out 3 (ancestors 1))) (birth contains)) (viewStats cycle))) 1\n"
                    "**** (skg (node (id 0) (source main) (affectsParent false) indef (rels (contains (out 1 (ancestors 1))) (birth contains)))) 0\n"
