    ...
    (let* ((buffer-content (buffer-substring-no-properties
           ...
           (expected
            (concat "* (skg (node (id 1) (source main) (graphStats (contents 3) (containsHerald {3)))) 1\n"
                    ...
                    "*** (skg (node (id 1) (source main) parentIgnores indefinitive (graphStats (contents 3) (containsHerald {3)) (viewStats cycle notInParent containsParent))) 1\n"
                    "**** (skg (node (id 0) (source main) parentIgnores indefinitive (graphStats (containers 0) (contents 1) (containsHerald 0{1)) (viewStats notInParent containsParent))) 0\n"
