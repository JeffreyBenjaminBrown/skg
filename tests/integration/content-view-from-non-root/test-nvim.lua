...
T.check(parent_line:find(
    '(affectsParent false) indef (rels (contains (out 1 (ancestors 1))) (birth contains))', 1, true) ~= nil,
  string.format(
    'parent is not (affectsParent false) indef (rels (contains (out 1 (ancestors 1))) (birth contains)); '
    .. 'line: %s', parent_line))
