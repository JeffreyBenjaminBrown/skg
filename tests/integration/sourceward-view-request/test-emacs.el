...
(defun run-sourceward-view-test ()
  ...
  (let ((expected-line0
         (concat "* (skg (node (id 1) (source main) (graphStats (containers 0) (contents 2) (containsHerald 0{2)))) 1\n"
                 "** (skg (node (id 11) (source main) (graphStats (linksInFromLeaves 1) (linksHerald →1)))) 11\n"
        ...
        (expected-changed
         (concat "* (skg (node (id 1) (source main) (graphStats (containers 0) (contents 2) (containsHerald 0{2)))) 1\n"
                 "** (skg (node (id 11) (source main) (graphStats (linksInFromLeaves 1) (linksHerald →1)))) 11\n"
                 "*** (skg (node (id l-11) (source main) parentIgnores indefinitive (graphStats (containers 0) (containsHerald 0{)) (viewStats notInParent))) [[id:11][a link to 11]]\n"
                 "** (skg (node (id 12) (source main))) 12\n"))
