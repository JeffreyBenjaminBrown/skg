...
fn test_collect_dup_instructions_no_duplicates() {
    let instructions : Vec<DefineNode> = vec![
      create_instruction( create_test_node("id1", "Node 1",
                                           None, None, vec![]),
                          false),
      create_instruction( create_test_node("id2", "Node 2",
                                           None, None, vec![]),
                          false),
      create_instruction( create_test_node("id3", "Node 3",
                                           None, None, vec![]),
                          false), ];
...
fn test_collect_dup_instructions_with_duplicates() {
    let instructions : Vec<DefineNode> = vec![
        ...
        create_instruction(create_test_node("id2", "Node 2",
                                            None, None, vec![]),
                           false),
        create_instruction(create_test_node("id1", "Node 1 Second",
                                            None, None, vec![]),
                           false),
        create_instruction(create_test_node("id3", "Node 3",
                                            None, None, vec![]),
                           false),
        create_instruction(create_test_node("id1", "Node 1 Third",
                                            None, None, vec![]),
                           false), ];
