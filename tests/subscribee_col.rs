...
fn test_subscribee_col_appears_for_subscribers(
  ...
  block_on(async {
    ...
    let expected = indoc! {
      ...
      **** (skg (id 11-sees) (source away) (view (rels (containers 0))) (code (interp subscribee) indefinitive)) 11-sees
      *** (skg (id 111) (source home)) 111
      ** (skg (id 12) (source home)) 12
      *** (skg (code (interp subscribeeCol))) it subscribes to these
      **** (skg (id 12-sees) (source away) (view (rels (containers 0))) (code (interp subscribee) indefinitive)) 12-sees
