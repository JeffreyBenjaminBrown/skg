...
fn test_subscribee_folder_appears_for_subscribers(
  ...
  block_on(async {
    ...
    let expected = indoc! {
      ...
      **** (skg (node (id 11-sees) (source away) writeProtected (rels (contains (out 0 (unintegrated 0))) (subscribes (in 1 (ancestors 2))) (birth subscribes)) (viewStats (sourceHerald ⌂:away)))) 11-sees
      ...
      *** (skg subscribeeFolder)
      **** (skg (node (id 12-sees) (source away) writeProtected (rels (contains (out 0 (unintegrated 0))) (subscribes (in 1 (ancestors 2))) (birth subscribes)) (viewStats (sourceHerald ⌂:away)))) 12-sees
