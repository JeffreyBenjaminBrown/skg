...
****** TODO does not deserve definition
...
****** mk_skgnode
******* TODO rename skgnode_for_orgnode_in_tree
******* collect_aliases
******* collect_contents
...
** TODO completeOrgnodeForest_collectingDefinitiveRequests
*** completeNodePreorder_collectingDefinitiveRequests
**** TODO separate definitive request handling from this
     and do that in
       update_from_and_rerender_buffer
     right after
       completeOrgnodeForest_collectingDefinitiveRequests
**** TODO completes and *restores*, too
     e.g. w/ clobberIndefinitiveOrgnode
**** completeAliasCol
     Called only if one is present,
     Ensure it has all the aliases,
...
**** TODO use 'mark_visited_or_repeat_or_cycle' instead of these
***** make_indefinitive_if_repeated
****** DUP get_pid_in_pairtree
***** detect_cycle_and_mark
****** DUP get_pid_in_pairtree
       seems unnecessary --
       isn't the tree already normalized?
****** DUP is_ancestor_id
**** TODO call 'ensure_skgnode' here rather than in these
***** clobberIndefinitiveOrgnode
      set title, source, body=None
      store skgnode in pair if needed
****** ensure_skgnode
******* DUP get_pid_in_pairtree
******* DUP skgnode_and_orgnode_from_id
...
***** TODO not sure this deserves definition
***** collect_child_ids
***** REC completeNodePreorder_collectingDefinitiveRequests
**** wrapped_build_and_integrate_aliases_view
***** TODO rename these 'wrapped' functions to 'do it and clean up'
...
***** DUP remove_completed_view_request
** TODO execute_definitive_view_requests
