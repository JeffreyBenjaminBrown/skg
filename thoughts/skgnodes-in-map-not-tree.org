...
Update =update_from_and_rerender_buffer= to use v2 functions:
- Use =skgnode_map_from_save_instructions= instead of pairing
- Call v2 versions of completion, view requests, metadata setting
- Remove old pairing step
